...
<html >
  ...
  <form class="form-horizontal" role="form" action="">
			   <div class="form-group">
			      <br>
				  <div class="col-sm-12">
				   	  <label for="" class="col-sm-2 control-label">充值日期</label>
				   	  <div class="col-sm-4">
					      <div class="input-group date form_time col-md-12" data-date="" data-date-format="yyyy-mm-dd hh:ii:00" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
			                    <input class="form-control" size="16" type="text" value="" name="rechargeDate" readonly>
								<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
			              </div>
					  </div>
					  <label for="" class="col-sm-2 control-label">路卡编号</label>
				   	  <div class="col-sm-4">
					      <select style="width: 100%;" data-placeholder="" id="selectError2" name="lucaNo" data-rel="chosen">
                            <option value=""></option>
