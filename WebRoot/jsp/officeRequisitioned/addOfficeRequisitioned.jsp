  ...
  <form class="form-horizontal" role="form" action="">
			   <div class="form-group">
			      ...
			      <div class="col-sm-12">
				      ...
				      <div class="col-sm-4">
				      	 <input type="text" class="form-control" id="" name="porpuse">
				      </div>
				  </div>
			      <div class="col-sm-12"><br></div>
				  <div class="col-sm-12">
				      <label for="" class="col-sm-2 control-label">领用人</label>
				      <div class="col-sm-4">
				      	 <input type="text" class="form-control" id="" name="recipient">
				      </div>
				  </div>
				  <div class="col-sm-12"><br></div>
			      <div class="col-sm-12">
