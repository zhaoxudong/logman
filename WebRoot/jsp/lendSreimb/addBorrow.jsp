  ...
  <form class="form-horizontal" role="form" action="">
			   <div class="form-group">
				  ...
				  <div class="col-sm-12">
					  ...
					  <label for="" class="col-sm-2 control-label">借款人类型</label>
				   	  <div class="col-sm-4">
			      ...
			      <div class="col-sm-12">
				      <label for="" class="col-sm-2 control-label">借款人名称</label>
				      <div class="col-sm-4">
					      <select style="width: 100%;" data-placeholder="" id="selectError2" name="name" data-rel="chosen">
                            <option value=""></option>
                                <option>Dallas Cowboys</option>
                                <option>New York Giants</option>
                                <option>Philadelphia Eagles</option>
				      ...
				      <label for="" class="col-sm-2 control-label">用途</label>
				      <div class="col-sm-4">
					      <select style="width: 100%;" data-placeholder="" id="selectError2" name="usePurpose" data-rel="chosen">
                            <option value=""></option>
                                <option>Dallas Cowboys</option>
                                <option>New York Giants</option>
                                <option>Philadelphia Eagles</option>
				  ...
				  <div class="col-sm-12">
				      ...
				      <div class="col-sm-4">
				      	 <input type="text" class="form-control" id="" name="depositNo">
				      </div>
				      <label for="" class="col-sm-2 control-label">支付账户</label>
				      <div class="col-sm-4">
