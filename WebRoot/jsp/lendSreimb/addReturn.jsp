  ...
  <form class="form-horizontal" role="form" action="">
			   <div class="form-group">
				  ...
				  <div class="col-sm-12">
					  ...
					  <label for="" class="col-sm-2 control-label">付款账户</label>
				   	  <div class="col-sm-4">
					      <select style="width: 100%;" data-placeholder="" id="selectError2" name="payaccount" data-rel="chosen">
                            <option value=""></option>
			      ...
			      <div class="col-sm-12">
				      ...
				      <label for="" class="col-sm-2 control-label">支票号</label>
				      <div class="col-sm-4">
				         <input type="text" class="form-control" id="" name="checkNumber">
				      </div>
				  </div>
			      <div class="col-sm-12"><br></div>
				  <div class="col-sm-12">
